...
class CorrelationFunction(Function):
    ...
    def backward(ctx, grad_output):
        ...
        with torch.cuda.device_of(input1):
            ...
            correlation_cuda.backward(input1, input2, rbot1, rbot2, grad_output, grad_input1, grad_input2,nctx.pad_size, ctx.kernel_size, ctx.max_displacement,ctx.stride1, ctx.stride2, ctx.corr_multiply)
